# Lattice ECP5 ADS1299 FPGA reference

Global ecosystem rank: **78**. Status: **Reference**. No board, synthesis, timing or hardware claim is made.

- FPGA family: ECP5
- Development tool baseline: Radiant or open-source ECP5 flow; pin the exact version in the consuming project
