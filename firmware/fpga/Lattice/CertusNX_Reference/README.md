# Lattice Certus-NX ADS1299 FPGA reference

Global ecosystem rank: **79**. Status: **Reference**. No board, synthesis, timing or hardware claim is made.

- FPGA family: Certus-NX
- Development tool baseline: Radiant; pin the exact version in the consuming project
