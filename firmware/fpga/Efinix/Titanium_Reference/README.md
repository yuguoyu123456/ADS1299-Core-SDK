# Efinix Titanium ADS1299 FPGA reference

Global ecosystem rank: **85**. Status: **Reference**. No board, synthesis, timing or hardware claim is made.

- FPGA family: Titanium
- Development tool baseline: Efinity; pin the exact version in the consuming project
