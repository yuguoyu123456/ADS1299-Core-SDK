# Microchip FPGA PolarFire ADS1299 FPGA reference

Global ecosystem rank: **80**. Status: **Reference**. No board, synthesis, timing or hardware claim is made.

- FPGA family: PolarFire
- Development tool baseline: Libero SoC; pin the exact version in the consuming project
