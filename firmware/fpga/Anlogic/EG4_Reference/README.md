# Anlogic EG4 ADS1299 FPGA reference

Global ecosystem rank: **83**. Status: **Reference**. No board, synthesis, timing or hardware claim is made.

- FPGA family: EG4
- Development tool baseline: Tang Dynasty; pin the exact version in the consuming project
