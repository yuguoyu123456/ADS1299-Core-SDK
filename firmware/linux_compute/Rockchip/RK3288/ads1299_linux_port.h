#ifndef RK3288_ADS1299_LINUX_PORT_H
#define RK3288_ADS1299_LINUX_PORT_H
...
typedef struct {
    ...
    int drdy_fd;
    uint32_t spi_hz;
} rk3288_ads1299_linux_t;

/* Returns 0 on success and a negative errno-style value on failure. */
...
/* Bind the opened Linux context to the portable shared ADS1299 core. */
