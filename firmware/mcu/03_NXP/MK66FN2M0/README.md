# MK66FN2M0 ADS1299 Port

Global ecosystem rank: **140**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: NXP
- Family / MCU: MK66FN2M0 / MK66FN2M0
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official MK66FN2M0 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 MK66FN2M0 的官方 SDK 绑定。
