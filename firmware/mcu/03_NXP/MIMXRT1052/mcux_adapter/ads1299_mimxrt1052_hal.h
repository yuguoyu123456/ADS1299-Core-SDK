#ifndef ADS1299_MIMXRT1052_HAL_H
#define ADS1299_MIMXRT1052_HAL_H
...
typedef struct {
    GPIO_Type *gpio;
    uint32_t pin;
} ads1299_mimxrt1052_gpio_t;

typedef struct {
    LPSPI_Type *lpspi;
    uint32_t source_clock_hz;
    uint32_t baud_hz;
    ads1299_mimxrt1052_gpio_t cs;
    ads1299_mimxrt1052_gpio_t reset;
    ads1299_mimxrt1052_gpio_t pwdn;
    ads1299_mimxrt1052_gpio_t start;
    ads1299_mimxrt1052_gpio_t drdy;
    void (*delay_us)(uint32_t us);
} ads1299_mimxrt1052_hal_context_t;
