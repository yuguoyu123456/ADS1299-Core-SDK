# MCXW716 ADS1299 Port

Global ecosystem rank: **130**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: NXP
- Family / MCU: MCXW716 / MCXW716
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official MCXW716 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 MCXW716 的官方 SDK 绑定。
