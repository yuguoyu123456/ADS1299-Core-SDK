...
static int adapter_fail(ads1299_mcxa153_context_t *ctx)
{
    if (ctx) ctx->fault = 1;
    return -1;
}
...
{
    ads1299_mcxa153_context_t *ctx = (ads1299_mcxa153_context_t *)user;
    uint8_t zeros[32] = {0};
    uint8_t discard[32];
...
int ads1299_mcxa153_make_hal(ads1299_mcxa153_context_t *ctx,
