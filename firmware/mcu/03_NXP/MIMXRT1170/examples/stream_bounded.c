/* MIMXRT1170 beginner step 5: bounded 250-SPS EEG streaming handoff.
 *
...
/* Single-producer/single-consumer foreground handoff. */
...
int main(void)
{
    ...
    for (;;) {
        ...
        /* No UART/USB/network write in the acquisition path. The consumer
         * drains ads1299_stream_pop() independently and can inspect overflow. */
    }
}
