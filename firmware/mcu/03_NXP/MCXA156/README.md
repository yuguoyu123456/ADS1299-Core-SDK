# MCXA156 ADS1299 Port

Global ecosystem rank: **129**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: NXP
- Family / MCU: MCXA156 / MCXA156
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official MCXA156 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 MCXA156 的官方 SDK 绑定。
