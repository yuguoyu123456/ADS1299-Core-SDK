/* MCXW236 beginner step 4: 250-SPS normal-electrode acquisition.
 * ADS1299 register semantics remain in the shared core. Radio/network work
 * must stay outside this DRDY acquisition path. */
#include "ads1299.h"
