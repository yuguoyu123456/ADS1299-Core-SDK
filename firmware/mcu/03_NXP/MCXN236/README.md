# MCXN236 ADS1299 Port

Global ecosystem rank: **127**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: NXP
- Family / MCU: MCXN236 / MCXN236
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official MCXN236 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 MCXN236 的官方 SDK 绑定。
