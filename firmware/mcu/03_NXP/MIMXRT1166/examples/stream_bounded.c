/* MIMXRT1166 beginner step 5: bounded 250-SPS EEG streaming handoff.
 *
...
/* Single-producer/single-consumer helper.  Call from the foreground transport
 * task/loop; do not call concurrently from multiple consumers. */
...
int main(void)
{
    ...
    for (;;) {
        ...
        /* Intentionally no UART/USB/network write here.  The transport layer
         * drains ads1299_stream_pop() independently so acquisition remains
         * bounded when output is slow. */
    }
}
