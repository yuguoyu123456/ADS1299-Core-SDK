# MIMXRT1189 ADS1299 Port

Global ecosystem rank: **137**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: NXP
- Family / MCU: MIMXRT1189 / MIMXRT1189
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official MIMXRT1189 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 MIMXRT1189 的官方 SDK 绑定。
编号是项目维护顺序，不是全球销量排名，也不表示未来供货保证。

选型理由：覆盖 MCX 新平台及已有 i.MX RT、LPC、Kinetis 工程迁移候选。
...
[官方资料入口](https://www.nxp.com/) · [101–200 总清单](../../ECOSYSTEM_101_200.md)
