 ...
 *
 * Keep this file fail-closed until the chosen MIMXRT1011 board has been
 * configured in MCUXpresso Config Tools.  Do not edit the shared ADS1299 core.
 * Replace the zero/null values below with the LPSPI instance, source clock,
 * GPIO ports/pins and a microsecond delay implementation from the generated
 * board project, then set BOARD_ADS1299_WIRING_REVIEWED to 1.
 */
...
static inline ads1299_mimxrt1011_hal_context_t board_ads1299_context(void)
{
    ads1299_mimxrt1011_hal_context_t ctx = {
