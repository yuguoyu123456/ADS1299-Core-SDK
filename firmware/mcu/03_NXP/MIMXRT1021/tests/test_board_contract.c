/*
 * Host-side smoke test for the MIMXRT1021 board integration seam.
 *
 ...
 * The real evkmimxrt1020 target remains TEMPLATE / NOT BUILD-VERIFIED /
...
static ads1299_mimxrt1021_hal_context_t g_context;
