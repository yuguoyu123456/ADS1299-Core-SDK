/* MIMXRT1062 bounded acquisition example.
...
/* Call this from the foreground transport task/loop. It is intentionally
 * transport-neutral: encode/send the returned frame outside the DRDY path. */
...
int main(void) {
    ...
    for (;;) {
        ...
        /* A real application drains with ads1299_stream_try_pop() from a
         * foreground task/transport service. Do not block here on I/O. */
    }
}
