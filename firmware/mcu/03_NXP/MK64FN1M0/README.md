# MK64FN1M0 ADS1299 Port

Global ecosystem rank: **139**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: NXP
- Family / MCU: MK64FN1M0 / MK64FN1M0
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official MK64FN1M0 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 MK64FN1M0 的官方 SDK 绑定。
