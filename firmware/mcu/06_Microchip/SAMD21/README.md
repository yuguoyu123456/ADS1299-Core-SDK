...
Global ecosystem rank: **158**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Microchip
- Family / MCU: SAMD21 / SAMD21
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official SAMD21 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 SAMD21 的官方 SDK 绑定。
