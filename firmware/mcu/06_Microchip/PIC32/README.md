...
Global ecosystem rank: **51**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Microchip
- Family / MCU: PIC32 / PIC32
- Architecture: MIPS32 or Arm by family
- Reference board: Select an official PIC32 evaluation board
