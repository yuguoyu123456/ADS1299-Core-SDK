# Integration with MPLAB device packs

1. Install the official `MPLAB device packs` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `AVR Classic` / `Select an official AVR Classic evaluation board`.
