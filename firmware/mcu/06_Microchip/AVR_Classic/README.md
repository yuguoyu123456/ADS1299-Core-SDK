# AVR Classic ADS1299 Port

Global ecosystem rank: **53**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Microchip
- Family / MCU: AVR Classic / AVR Classic
- Architecture: 8-bit AVR
- Reference board: Select an official AVR Classic evaluation board
- Official environment: MPLAB device packs
