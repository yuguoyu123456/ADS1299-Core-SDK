...
Global ecosystem rank: **162**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Microchip
- Family / MCU: SAMV71 / SAMV71
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official SAMV71 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 SAMV71 的官方 SDK 绑定。
