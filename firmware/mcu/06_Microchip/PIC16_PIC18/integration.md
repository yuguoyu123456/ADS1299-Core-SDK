# Integration with MPLAB XC8

1. Install the official `MPLAB XC8` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `PIC16/PIC18` / `Select an official PIC16/PIC18 evaluation board`.
