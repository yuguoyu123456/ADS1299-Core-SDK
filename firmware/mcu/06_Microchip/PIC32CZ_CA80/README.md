# PIC32CZ_CA80 ADS1299 Port

Global ecosystem rank: **165**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Microchip
- Family / MCU: PIC32CZ_CA80 / PIC32CZ_CA80
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official PIC32CZ_CA80 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 PIC32CZ_CA80 的官方 SDK 绑定。
