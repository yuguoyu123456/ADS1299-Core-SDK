...
1. Install the official `MPLAB Harmony 3` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `ATSAME54P20A` / `SAME54 Xplained Pro`.
...
callback adapter and ADS1299-independent tests. Pin `CSP examples 3.6.1; GNU reference link verified; XC32 not run` in the
