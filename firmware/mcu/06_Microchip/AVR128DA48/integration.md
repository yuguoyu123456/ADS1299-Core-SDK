# Integration with MPLAB XC8 / AVR Dx device pack

1. Install the official `MPLAB XC8 / AVR Dx device pack` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `AVR128DA48` / `AVR128DA48 Curiosity Nano`.
...
callback adapter and ADS1299-independent tests. Pin `pin in MPLAB project` in the
