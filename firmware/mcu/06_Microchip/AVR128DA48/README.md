# AVR128DA48 ADS1299 Port

Global ecosystem rank: **52**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Microchip
- Family / MCU: AVR DA / AVR128DA48
- Architecture: 8-bit AVR
- Reference board: AVR128DA48 Curiosity Nano
- Official environment: MPLAB XC8 / AVR Dx device pack
- Compiler: avr-gcc / XC8
