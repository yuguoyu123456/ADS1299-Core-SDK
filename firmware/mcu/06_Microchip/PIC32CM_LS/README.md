# PIC32CM_LS ADS1299 Port

Global ecosystem rank: **164**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Microchip
- Family / MCU: PIC32CM_LS / PIC32CM_LS
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official PIC32CM_LS evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 PIC32CM_LS 的官方 SDK 绑定。
