# Integration with MM32 HAL/SPL

1. Install the official `MM32 HAL/SPL` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `MM32F3277G9P` / `MM32F3277 evaluation board`.
