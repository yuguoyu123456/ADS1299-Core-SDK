# Integration with MM32 SDK

1. Install the official `MM32 SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `MM32W` / `Select an official MM32W evaluation board`.
