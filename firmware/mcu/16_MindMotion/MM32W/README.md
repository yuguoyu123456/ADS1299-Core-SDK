...
Global ecosystem rank: **48**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: MindMotion
- Family / MCU: MM32W / MM32W
- Architecture: Arm Cortex-M class
- Reference board: Select an official MM32W evaluation board
- Official environment: MM32 SDK
