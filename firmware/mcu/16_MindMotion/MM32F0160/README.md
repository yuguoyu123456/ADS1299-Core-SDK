# MM32F0160 ADS1299 Port

Global ecosystem rank: **191**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: MindMotion
- Family / MCU: MM32F0160 / MM32F0160
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official MM32F0160 evaluation board
- Official environment: MM32 device SDK
...
当前是 **Planned** 目录和通用回调模板，尚未实现 MM32F0160 的官方 SDK 绑定。
编号是项目维护顺序，不是全球销量排名，也不表示未来供货保证。

选型理由：补充国内通用系列；按手册逐项确认时钟、SPI 和 DMA 能力。
...
[官方资料入口](https://www.mindmotion.com.cn/products/) · [101–200 总清单](../../ECOSYSTEM_101_200.md)
