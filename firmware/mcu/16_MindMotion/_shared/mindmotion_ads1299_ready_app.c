#include "mindmotion_ads1299_ready_app.h"

static ads1299_status_t mindmotion_apply_profile(ads1299_t *dev,
                                            ...
                                            int verify_registers)
{
    ...
    return mindmotion_apply_profile(dev, profile, verify_registers);
}
