...
Global ecosystem rank: **43**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Bouffalo Lab
- Family / MCU: BL616 / BL616
- Architecture: 32-bit RISC-V
- Reference board: Select an official BL616 evaluation board
- Official environment: Bouffalo SDK
