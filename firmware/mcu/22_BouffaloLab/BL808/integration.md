# Integration with Bouffalo SDK

1. Install the official `Bouffalo SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `BL808` / `Select an official BL808 evaluation board`.
