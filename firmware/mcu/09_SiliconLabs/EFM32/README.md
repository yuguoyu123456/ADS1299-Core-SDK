...
Global ecosystem rank: **64**. Status: **Reference**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Silicon Labs
- Family / MCU: EFM32 / EFM32
- Architecture: Arm Cortex-M
- Reference board: Select an official EFM32 evaluation board
