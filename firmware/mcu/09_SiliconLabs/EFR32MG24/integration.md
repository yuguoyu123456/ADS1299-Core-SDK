# Integration with Gecko SDK / emlib

1. Install the official `Gecko SDK / emlib` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `EFR32MG24` / `xG24 Explorer Kit`.
...
callback adapter and ADS1299-independent tests. Pin `pin in Simplicity Studio project` in the
