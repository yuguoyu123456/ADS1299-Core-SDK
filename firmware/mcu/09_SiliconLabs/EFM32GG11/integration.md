# Integration with Simplicity Studio / device SDK

1. Install the official `Simplicity Studio / device SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `EFM32GG11` / `Select an official EFM32GG11 evaluation board`.
