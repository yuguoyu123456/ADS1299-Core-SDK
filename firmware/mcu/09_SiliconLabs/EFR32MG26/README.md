# EFR32MG26 ADS1299 Port

Global ecosystem rank: **174**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Silicon Labs
- Family / MCU: EFR32MG26 / EFR32MG26
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official EFR32MG26 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 EFR32MG26 的官方 SDK 绑定。
