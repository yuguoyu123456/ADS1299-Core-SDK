# HC32F460PETB ADS1299 Port

Global ecosystem rank: **37**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: HDSC
- Family / MCU: HC32F460 / HC32F460PETB
- Architecture: Arm Cortex-M4F
- Reference board: HC32F460 evaluation board
- Official environment: HDSC DDL
