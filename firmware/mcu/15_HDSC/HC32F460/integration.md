# Integration with HDSC DDL

1. Install the official `HDSC DDL` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `HC32F460PETB` / `HC32F460 evaluation board`.
