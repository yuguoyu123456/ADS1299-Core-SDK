#include "hdsc_ads1299_ready_app.h"

static ads1299_status_t hdsc_apply_profile(ads1299_t *dev,
                                      ...
                                      int verify_registers)
{
    ...
    return hdsc_apply_profile(dev, profile, verify_registers);
}
