# HC32F4A0 ADS1299 Port

Global ecosystem rank: **190**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: HDSC
- Family / MCU: HC32F4A0 / HC32F4A0
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official HC32F4A0 evaluation board
- Official environment: HC32 device DDL
...
当前是 **Planned** 目录和通用回调模板，尚未实现 HC32F4A0 的官方 SDK 绑定。
编号是项目维护顺序，不是全球销量排名，也不表示未来供货保证。

选型理由：补充国内控制器选型；先锁定官方 DDL 版本及封装。
...
[官方资料入口](https://www.xhsc.com.cn/) · [101–200 总清单](../../ECOSYSTEM_101_200.md)
