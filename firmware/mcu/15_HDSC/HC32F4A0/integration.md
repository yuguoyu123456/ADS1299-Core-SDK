# Integration with HC32 device DDL

1. Install the official `HC32 device DDL` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `HC32F4A0` / `Select an official HC32F4A0 evaluation board`.
