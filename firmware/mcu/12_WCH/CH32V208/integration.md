# Integration with WCH official EVT / MounRiver toolchain

1. Install the official `WCH official EVT / MounRiver toolchain` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `CH32V208` / `Select an official CH32V208 evaluation board`.
