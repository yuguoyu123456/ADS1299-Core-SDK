# CH32V203 ADS1299 Port

Global ecosystem rank: **34**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: WCH
- Family / MCU: CH32V203 / CH32V203
- Architecture: QingKe RISC-V
- Reference board: Select an official CH32V203 evaluation board
- Official environment: WCH EVT / NoneOS SDK
