# Integration with WCH EVT / NoneOS SDK

1. Install the official `WCH EVT / NoneOS SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `CH32V203` / `Select an official CH32V203 evaluation board`.
