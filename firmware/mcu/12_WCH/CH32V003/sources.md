...
- Device/family candidate: CH32V003; vendor: WCH.
- [Official discovery entry](https://www.wch-ic.com/products/productsCenter/mcuInterface?categoryId=70). This may be a vendor catalog, not an exact-part datasheet.
