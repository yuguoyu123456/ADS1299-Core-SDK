# CH32V003 ADS1299 Port

Global ecosystem rank: **181**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: WCH
- Family / MCU: CH32V003 / CH32V003
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official CH32V003 evaluation board
- Official environment: WCH official EVT / MounRiver toolchain
...
当前是 **Planned** 目录和通用回调模板，尚未实现 CH32V003 的官方 SDK 绑定。
编号是项目维护顺序，不是全球销量排名，也不表示未来供货保证。

选型理由：补充低成本、无线和高速接口候选；低资源器件先做 Core 容量评估。
...
[官方资料入口](https://www.wch-ic.com/products/productsCenter/mcuInterface?categoryId=70) · [101–200 总清单](../../ECOSYSTEM_101_200.md)
