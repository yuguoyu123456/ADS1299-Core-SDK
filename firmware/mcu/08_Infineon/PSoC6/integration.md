# Integration with ModusToolbox HAL

1. Install the official `ModusToolbox HAL` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `CY8C624ABZI-S2D44` / `CY8CKIT-062S2-43012`.
...
callback adapter and ADS1299-independent tests. Pin `PDL 3.17.0 / BSP 5.0.1 / core-lib 1.4.4; GNU reference link verified` in the
