...
ads1299_status_t infineon_ads1299_start(ads1299_t *dev)
{
    return dev ? ads1299_profile_start_streaming(dev) : ADS1299_EINVAL;
}

ads1299_status_t infineon_ads1299_read_one(ads1299_t *dev,
                                          infineon_ads1299_ready_state_t *state)
{
    ads1299_status_t st;
...
ads1299_status_t infineon_ads1299_stop(ads1299_t *dev)
{
