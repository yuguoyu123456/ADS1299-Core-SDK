# XMC4500 ADS1299 Port

Global ecosystem rank: **170**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Infineon
- Family / MCU: XMC4500 / XMC4500
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official XMC4500 evaluation board
- Official environment: XMC device-supported SDK / ModusToolbox or DAVE as applicable
...
当前是 **Planned** 目录和通用回调模板，尚未实现 XMC4500 的官方 SDK 绑定。
编号是项目维护顺序，不是全球销量排名，也不表示未来供货保证。

选型理由：补充 XMC 工业控制平台；先验证 SPI 接口和工程环境再扩大采集规模。
...
[官方资料入口](https://www.infineon.com/) · [101–200 总清单](../../ECOSYSTEM_101_200.md)
