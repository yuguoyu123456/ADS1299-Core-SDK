# XMC4700 ADS1299 Port

Global ecosystem rank: **171**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Infineon
- Family / MCU: XMC4700 / XMC4700
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official XMC4700 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 XMC4700 的官方 SDK 绑定。
