# Integration with XMC device-supported SDK / ModusToolbox or DAVE as applicable

1. Install the official `XMC device-supported SDK / ModusToolbox or DAVE as applicable` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `XMC7200` / `Select an official XMC7200 evaluation board`.
