...
Global ecosystem rank: **23**. Status: **Compiles**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Raspberry Pi
- Family / MCU: RP2350 / RP2350
- Architecture: dual Arm Cortex-M33 or Hazard3 RISC-V
- Reference board: Raspberry Pi Pico 2
- Official environment: Pico SDK
