...
Build entrypoint: `cmake --build /tmp/rp2350-build -j 2 (see pico2-reference.yml)`. A pinned CI build definition is retained; it was not rerun locally in this maintenance session.
