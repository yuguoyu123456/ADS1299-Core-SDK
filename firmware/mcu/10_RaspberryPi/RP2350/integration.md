...
1. Install the official `Pico SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `RP2350` / `Raspberry Pi Pico 2`.
...
callback adapter and ADS1299-independent tests. Pin `2.3.0 reference` in the
