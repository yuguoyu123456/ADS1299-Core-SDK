...
Build entrypoint: `cmake --build /tmp/rp2040-build -j 2 (see pico-reference.yml)`. A pinned CI build definition is retained; it was not rerun locally in this maintenance session.
