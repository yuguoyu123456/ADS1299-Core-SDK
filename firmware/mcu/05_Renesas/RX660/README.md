...
Global ecosystem rank: **155**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Renesas
- Family / MCU: RX660 / RX660
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official RX660 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 RX660 的官方 SDK 绑定。
