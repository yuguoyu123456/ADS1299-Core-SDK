# Integration with Renesas FSP

1. Install the official `Renesas FSP` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `R7FA6M5BH3CFC` / `EK-RA6M5`.
...
callback adapter and ADS1299-independent tests. Pin `5.6.0 reference ELF verified; 6.5.0 API tested only` in the
