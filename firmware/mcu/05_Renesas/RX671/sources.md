...
- Device/family candidate: RX671; vendor: Renesas.
- [Official discovery entry](https://www.renesas.com/en/products/microcontrollers-microprocessors). This may be a vendor catalog, not an exact-part datasheet.
