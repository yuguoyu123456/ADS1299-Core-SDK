# Integration with RX Driver Package / FIT

1. Install the official `RX Driver Package / FIT` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `R5F572NNHDFB` / `RX72N Envision Kit`.
...
callback adapter and ADS1299-independent tests. Pin `pin in e2 studio project` in the
