# Synergy ADS1299 Port

Global ecosystem rank: **57**. Status: **Planned**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Renesas
- Family / MCU: Synergy / Synergy
- Architecture: Arm Cortex-M
- Reference board: Select an official Synergy evaluation board
- Official environment: Synergy Software Package
