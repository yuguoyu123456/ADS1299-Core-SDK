# Integration with Synergy Software Package

1. Install the official `Synergy Software Package` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `Synergy` / `Select an official Synergy evaluation board`.
