# Integration with FSP for RA; FIT/RX Driver Package for RX

1. Install the official `FSP for RA; FIT/RX Driver Package for RX` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `RA8M1` / `Select an official RA8M1 evaluation board`.
