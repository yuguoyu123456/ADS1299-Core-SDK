# Integration with SmartSnippets SDK

1. Install the official `SmartSnippets SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `DA1469x` / `Select an official DA1469x evaluation board`.
