# Integration with RL78 Smart Configurator

1. Install the official `RL78 Smart Configurator` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `RL78` / `Select an official RL78 evaluation board`.
