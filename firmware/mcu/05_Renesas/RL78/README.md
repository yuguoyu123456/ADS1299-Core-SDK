...
Global ecosystem rank: **56**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Renesas
- Family / MCU: RL78 / RL78
- Architecture: 16-bit RL78
- Reference board: Select an official RL78 evaluation board
- Official environment: RL78 Smart Configurator
