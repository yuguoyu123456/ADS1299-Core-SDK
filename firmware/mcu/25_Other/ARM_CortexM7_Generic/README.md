# Cortex-M7 ADS1299 Port

Global ecosystem rank: **96**. Status: **Reference**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: ARM Generic
- Family / MCU: Cortex-M7 / Cortex-M7
- Architecture: Arm Cortex-M7
- Reference board: Select an official Cortex-M7 evaluation board
