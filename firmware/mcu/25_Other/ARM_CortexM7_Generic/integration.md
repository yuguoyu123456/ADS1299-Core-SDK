# Integration with CMSIS device pack supplied by silicon vendor

1. Install the official `CMSIS device pack supplied by silicon vendor` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `Cortex-M7` / `Select an official Cortex-M7 evaluation board`.
