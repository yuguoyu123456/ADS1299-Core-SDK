# Pine RISC-V IoT ADS1299 Port

Global ecosystem rank: **45**. Status: **Planned**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Xiaomi
- Family / MCU: Pine RISC-V IoT / Pine RISC-V IoT
- Architecture: RISC-V
- Reference board: Select an official Pine RISC-V IoT evaluation board
