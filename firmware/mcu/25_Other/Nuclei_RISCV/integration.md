# Integration with Nuclei SDK

1. Install the official `Nuclei SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `RISC-V` / `Select an official RISC-V evaluation board`.
