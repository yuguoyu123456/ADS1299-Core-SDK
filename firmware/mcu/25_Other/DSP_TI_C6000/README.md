# C6000 DSP ADS1299 Port

Global ecosystem rank: **98**. Status: **Reference**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Texas Instruments
- Family / MCU: C6000 DSP / C6000 DSP
- Architecture: TI C6000 DSP
- Reference board: Select an official C6000 DSP evaluation board
- Official environment: Processor SDK / Code Composer Studio
