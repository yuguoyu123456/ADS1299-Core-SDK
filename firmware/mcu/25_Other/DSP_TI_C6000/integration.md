# Integration with Processor SDK / Code Composer Studio

1. Install the official `Processor SDK / Code Composer Studio` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `C6000 DSP` / `Select an official C6000 DSP evaluation board`.
