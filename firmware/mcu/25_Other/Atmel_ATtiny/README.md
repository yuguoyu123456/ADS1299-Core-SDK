...
Global ecosystem rank: **92**. Status: **Reference**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Atmel Legacy
- Family / MCU: ATtiny / ATtiny
- Architecture: 8-bit AVR
- Reference board: Select an official ATtiny evaluation board
