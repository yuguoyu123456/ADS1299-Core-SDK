# Integration with board-specific SDK

1. Install the official `board-specific SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `Maix/RISC-V` / `Select an official Maix/RISC-V evaluation board`.
