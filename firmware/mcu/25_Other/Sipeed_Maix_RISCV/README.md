# Maix/RISC-V ADS1299 Port

Global ecosystem rank: **86**. Status: **Reference**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Sipeed
- Family / MCU: Maix/RISC-V / Maix/RISC-V
- Architecture: RISC-V
- Reference board: Select an official Maix/RISC-V evaluation board
- Official environment: board-specific SDK
