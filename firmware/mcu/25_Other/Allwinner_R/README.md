# R series ADS1299 Port

Global ecosystem rank: **68**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Allwinner
- Family / MCU: R series / R series
- Architecture: Arm/RISC-V by device
- Reference board: Select an official R series evaluation board
- Official environment: official BSP required
