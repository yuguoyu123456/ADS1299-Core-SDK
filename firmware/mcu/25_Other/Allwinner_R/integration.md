# Integration with official BSP required

1. Install the official `official BSP required` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `R series` / `Select an official R series evaluation board`.
