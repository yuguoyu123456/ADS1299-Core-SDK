# Integration with Freedom E SDK

1. Install the official `Freedom E SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `Freedom` / `Select an official Freedom evaluation board`.
