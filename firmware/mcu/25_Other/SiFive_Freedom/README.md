# Freedom ADS1299 Port

Global ecosystem rank: **88**. Status: **Reference**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: SiFive
- Family / MCU: Freedom / Freedom
- Architecture: RISC-V
- Reference board: Select an official Freedom evaluation board
- Official environment: Freedom E SDK
