# Integration with vendor SoC SDK required

1. Install the official `vendor SoC SDK required` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `Tensilica DSP` / `Select an official Tensilica DSP evaluation board`.
