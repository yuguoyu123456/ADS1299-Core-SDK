# Tensilica DSP ADS1299 Port

Global ecosystem rank: **100**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Cadence
- Family / MCU: Tensilica DSP / Tensilica DSP
- Architecture: configurable Xtensa/Tensilica
- Reference board: Select an official Tensilica DSP evaluation board
- Official environment: vendor SoC SDK required
