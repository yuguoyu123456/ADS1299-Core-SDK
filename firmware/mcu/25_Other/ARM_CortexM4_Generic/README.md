# Cortex-M4 ADS1299 Port

Global ecosystem rank: **95**. Status: **Reference**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: ARM Generic
- Family / MCU: Cortex-M4 / Cortex-M4
- Architecture: Arm Cortex-M4
- Reference board: Select an official Cortex-M4 evaluation board
