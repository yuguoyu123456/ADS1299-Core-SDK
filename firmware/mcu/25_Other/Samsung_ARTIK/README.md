...
Global ecosystem rank: **60**. Status: **Planned**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Samsung
- Family / MCU: ARTIK / ARTIK
- Architecture: Arm application/MCU class
- Reference board: Select an official ARTIK evaluation board
- Official environment: ARTIK SDK
