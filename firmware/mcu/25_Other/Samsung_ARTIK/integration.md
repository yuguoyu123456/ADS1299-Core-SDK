# Integration with ARTIK SDK

1. Install the official `ARTIK SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `ARTIK` / `Select an official ARTIK evaluation board`.
