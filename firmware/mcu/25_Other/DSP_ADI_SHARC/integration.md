...
1. Install the official `CrossCore Embedded Studio` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `SHARC` / `Select an official SHARC evaluation board`.
