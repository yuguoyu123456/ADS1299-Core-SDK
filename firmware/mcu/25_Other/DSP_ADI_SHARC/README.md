...
Global ecosystem rank: **99**. Status: **Reference**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Analog Devices
- Family / MCU: SHARC / SHARC
- Architecture: ADI SHARC DSP
- Reference board: Select an official SHARC evaluation board
- Official environment: CrossCore Embedded Studio
