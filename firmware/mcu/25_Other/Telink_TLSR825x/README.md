# TLSR825x ADS1299 Port

Global ecosystem rank: **30**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Telink
- Family / MCU: TLSR825x / TLSR825x
- Architecture: 32-bit proprietary/RISC core
- Reference board: Select an official TLSR825x evaluation board
- Official environment: Telink BLE SDK
