# Integration with official SDK required

1. Install the official `official SDK required` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `MCU/IoT family unspecified` / `Select an official MCU/IoT family unspecified evaluation board`.
