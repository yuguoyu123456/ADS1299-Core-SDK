# MCU/IoT family unspecified ADS1299 Port

Global ecosystem rank: **70**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Rockchip
- Family / MCU: MCU/IoT family unspecified / MCU/IoT family unspecified
- Architecture: device not selected
- Reference board: Select an official MCU/IoT family unspecified evaluation board
- Official environment: official SDK required
