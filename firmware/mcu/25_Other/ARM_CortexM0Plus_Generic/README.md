# Cortex-M0+ ADS1299 Port

Global ecosystem rank: **93**. Status: **Reference**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: ARM Generic
- Family / MCU: Cortex-M0+ / Cortex-M0+
- Architecture: Arm Cortex-M0+
- Reference board: Select an official Cortex-M0+ evaluation board
- Official environment: CMSIS device pack supplied by silicon vendor
