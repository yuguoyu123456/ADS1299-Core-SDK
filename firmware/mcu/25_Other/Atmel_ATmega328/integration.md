# Integration with avr-libc / Microchip device pack

1. Install the official `avr-libc / Microchip device pack` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `ATmega328` / `Select an official ATmega328 evaluation board`.
