...
Global ecosystem rank: **67**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Actions Semiconductor
- Family / MCU: ATS / ATS
- Architecture: proprietary/Arm by device
- Reference board: Select an official ATS evaluation board
