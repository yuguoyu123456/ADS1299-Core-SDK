# Integration with vendor BSP required

1. Install the official `vendor BSP required` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `RV32` / `Select an official RV32 evaluation board`.
