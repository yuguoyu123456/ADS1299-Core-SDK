# Integration with official Nations SDK

1. Install the official `official Nations SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `M4 series` / `Select an official M4 series evaluation board`.
