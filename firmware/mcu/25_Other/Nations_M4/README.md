# M4 series ADS1299 Port

Global ecosystem rank: **46**. Status: **Planned**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Nations
- Family / MCU: M4 series / M4 series
- Architecture: Arm Cortex-M4
- Reference board: Select an official M4 series evaluation board
- Official environment: official Nations SDK
