...
Global ecosystem rank: **87**. Status: **Reference**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Kendryte
- Family / MCU: K210 / K210
- Architecture: dual RV64GC
- Reference board: Select an official K210 evaluation board
- Official environment: Kendryte standalone SDK
