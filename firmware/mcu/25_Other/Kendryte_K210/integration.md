# Integration with Kendryte standalone SDK

1. Install the official `Kendryte standalone SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `K210` / `Select an official K210 evaluation board`.
