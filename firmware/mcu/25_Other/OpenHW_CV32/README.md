...
Global ecosystem rank: **90**. Status: **Reference**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: OpenHW Group
- Family / MCU: CV32 / CV32
- Architecture: RISC-V
- Reference board: Select an official CV32 evaluation board
- Official environment: CORE-V SDK
