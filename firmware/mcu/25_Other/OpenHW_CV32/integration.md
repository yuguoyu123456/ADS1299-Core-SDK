# Integration with CORE-V SDK

1. Install the official `CORE-V SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `CV32` / `Select an official CV32 evaluation board`.
