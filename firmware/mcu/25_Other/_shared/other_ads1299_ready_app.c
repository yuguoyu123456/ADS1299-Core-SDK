#include "other_ads1299_ready_app.h"

static ads1299_status_t other_apply_profile(ads1299_t *dev,
                                            other_ads1299_profile_t profile,
...
ads1299_status_t other_ads1299_prepare(ads1299_t *dev,
                                       other_ads1299_profile_t profile,
                                       int verify_registers)
{
    ads1299_status_t rc;
    ...
    return other_apply_profile(dev, profile, verify_registers);
}

ads1299_status_t other_ads1299_start(ads1299_t *dev)
{
    return dev ? ads1299_profile_start_streaming(dev) : ADS1299_EINVAL;
}

ads1299_status_t other_ads1299_read_one(ads1299_t *dev,
                                        other_ads1299_state_t *state)
{
    ads1299_status_t rc;
...
ads1299_status_t other_ads1299_stop(ads1299_t *dev)
{
