# Integration with T-Head/Xuantie SDK

1. Install the official `T-Head/Xuantie SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `XuanTie RISC-V` / `Select an official XuanTie RISC-V evaluation board`.
