# XuanTie RISC-V ADS1299 Port

Global ecosystem rank: **50**. Status: **Planned**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: T-Head
- Family / MCU: XuanTie RISC-V / XuanTie RISC-V
- Architecture: RISC-V
- Reference board: Select an official XuanTie RISC-V evaluation board
- Official environment: T-Head/Xuantie SDK
