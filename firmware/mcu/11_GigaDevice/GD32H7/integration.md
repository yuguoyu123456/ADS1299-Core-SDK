# Integration with GD32H7xx Firmware Library

1. Install the official `GD32H7xx Firmware Library` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `GD32H7` / `Select an official GD32H7 evaluation board`.
