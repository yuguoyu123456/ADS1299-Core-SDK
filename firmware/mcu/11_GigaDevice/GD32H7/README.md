...
Global ecosystem rank: **32**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: GigaDevice
- Family / MCU: GD32H7 / GD32H7
- Architecture: Arm Cortex-M7
- Reference board: Select an official GD32H7 evaluation board
- Official environment: GD32H7xx Firmware Library
