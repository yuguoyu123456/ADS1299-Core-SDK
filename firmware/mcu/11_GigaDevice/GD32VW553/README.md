# GD32VW553 ADS1299 Port

Global ecosystem rank: **180**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: GigaDevice
- Family / MCU: GD32VW553 / GD32VW553
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official GD32VW553 evaluation board
- Official environment: GD32 device firmware library / wireless SDK
...
当前是 **Planned** 目录和通用回调模板，尚未实现 GD32VW553 的官方 SDK 绑定。
编号是项目维护顺序，不是全球销量排名，也不表示未来供货保证。

选型理由：覆盖国内通用、低功耗及无线选型；不同系列外设寄存器不可互换。
...
[官方资料入口](https://www.gigadevice.com/product/mcu) · [101–200 总清单](../../ECOSYSTEM_101_200.md)
