# Integration with GD32 device firmware library / wireless SDK

1. Install the official `GD32 device firmware library / wireless SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `GD32VW553` / `Select an official GD32VW553 evaluation board`.
