# GD32F303 ADS1299 Port

Global ecosystem rank: **176**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: GigaDevice
- Family / MCU: GD32F303 / GD32F303
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official GD32F303 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 GD32F303 的官方 SDK 绑定。
