# MSPM0G3507SPM ADS1299 Port

Global ecosystem rank: **6**. Status: **Reference**. Tier A. Hardware validation is not implied.

## Platform

- Vendor: Texas Instruments
- Family / MCU: MSPM0 / MSPM0G3507SPM
- Architecture: Arm Cortex-M0+
- Reference board: LP-MSPM0G3507
- Official environment: MSPM0 SDK DriverLib
