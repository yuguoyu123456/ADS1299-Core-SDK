# Integration with MSPM0 SDK DriverLib

1. Install the official `MSPM0 SDK DriverLib` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `MSPM0G3507SPM` / `LP-MSPM0G3507`.
...
callback adapter and ADS1299-independent tests. Pin `2.11.00.07 reference` in the
