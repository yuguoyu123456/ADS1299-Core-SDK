# Integration with SimpleLink CC32xx SDK

1. Install the official `SimpleLink CC32xx SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `CC32xx` / `Select an official CC32xx evaluation board`.
