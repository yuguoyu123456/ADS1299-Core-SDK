# MSPM0L1306 ADS1299 Port

Global ecosystem rank: **141**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Texas Instruments
- Family / MCU: MSPM0L1306 / MSPM0L1306
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official MSPM0L1306 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 MSPM0L1306 的官方 SDK 绑定。
