# CC2745R10 ADS1299 Port

Global ecosystem rank: **143**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Texas Instruments
- Family / MCU: CC2745R10 / CC2745R10
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official CC2745R10 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 CC2745R10 的官方 SDK 绑定。
