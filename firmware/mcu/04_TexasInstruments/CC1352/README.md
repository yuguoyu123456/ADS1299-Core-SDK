...
Global ecosystem rank: **26**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Texas Instruments
- Family / MCU: CC1352 / CC1352
- Architecture: Arm Cortex-M4F
- Reference board: Select an official CC1352 evaluation board
