# Integration with C2000Ware DriverLib

1. Install the official `C2000Ware DriverLib` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `TMS320F28379D` / `LAUNCHXL-F28379D`.
