# Integration with SimpleLink CC13xx/CC26xx SDK

1. Install the official `SimpleLink CC13xx/CC26xx SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `CC2640/CC26xx` / `Select an official CC2640/CC26xx evaluation board`.
