...
- Device/family candidate: TM4C123GH6PM; vendor: Texas Instruments.
- [Official discovery entry](https://www.ti.com/microcontrollers-mcus-processors/microcontrollers/overview.html). This may be a vendor catalog, not an exact-part datasheet.
