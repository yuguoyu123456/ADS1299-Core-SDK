# TM4C123GH6PM ADS1299 Port

Global ecosystem rank: **146**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Texas Instruments
- Family / MCU: TM4C123GH6PM / TM4C123GH6PM
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official TM4C123GH6PM evaluation board
- Official environment: TI device-specific SDK / Code Composer Studio
...
当前是 **Planned** 目录和通用回调模板，尚未实现 TM4C123GH6PM 的官方 SDK 绑定。
编号是项目维护顺序，不是全球销量排名，也不表示未来供货保证。

选型理由：补充 MSPM0、SimpleLink 和存量 Tiva 工程；使用对应器件的官方 SDK。
...
[官方资料入口](https://www.ti.com/microcontrollers-mcus-processors/microcontrollers/overview.html) · [101–200 总清单](../../ECOSYSTEM_101_200.md)
