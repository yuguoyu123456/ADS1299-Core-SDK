# Integration with TI device-specific SDK / Code Composer Studio

1. Install the official `TI device-specific SDK / Code Composer Studio` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `TM4C123GH6PM` / `Select an official TM4C123GH6PM evaluation board`.
