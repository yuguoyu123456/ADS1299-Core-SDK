...
Global ecosystem rank: **55**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Texas Instruments
- Family / MCU: MSP430 / MSP430
- Architecture: 16-bit MSP430
- Reference board: Select an official MSP430 evaluation board
- Official environment: MSP430Ware
