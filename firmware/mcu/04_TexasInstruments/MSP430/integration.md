# Integration with MSP430Ware

1. Install the official `MSP430Ware` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `MSP430` / `Select an official MSP430 evaluation board`.
