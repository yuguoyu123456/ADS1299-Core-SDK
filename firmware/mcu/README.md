...
The next maintenance objective is not to add more names. It is to graduate these sixteen projects one by one from `Reference source / build-pending` to `Compiles` using their real vendor SDKs and CI/toolchain evidence.
