# Apollo4 ADS1299 Port

Global ecosystem rank: **61**. Status: **Reference**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Ambiq
- Family / MCU: Apollo4 / Apollo4
- Architecture: Arm Cortex-M4F
- Reference board: Select an official Apollo4 evaluation board
