# Apollo2 ADS1299 Port

Global ecosystem rank: **200**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Ambiq
- Family / MCU: Apollo2 / Apollo2
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official Apollo2 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 Apollo2 的官方 SDK 绑定。
