# Apollo3 ADS1299 Port

Global ecosystem rank: **62**. Status: **Reference**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Ambiq
- Family / MCU: Apollo3 / Apollo3
- Architecture: Arm Cortex-M4F
- Reference board: Select an official Apollo3 evaluation board
