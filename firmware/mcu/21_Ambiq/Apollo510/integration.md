# Integration with AmbiqSuite SDK

1. Install the official `AmbiqSuite SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `Apollo510` / `Select an official Apollo510 evaluation board`.
