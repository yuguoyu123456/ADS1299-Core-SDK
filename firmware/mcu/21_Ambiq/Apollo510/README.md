# Apollo510 ADS1299 Port

Global ecosystem rank: **199**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Ambiq
- Family / MCU: Apollo510 / Apollo510
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official Apollo510 evaluation board
- Official environment: AmbiqSuite SDK
...
当前是 **Planned** 目录和通用回调模板，尚未实现 Apollo510 的官方 SDK 绑定。
编号是项目维护顺序，不是全球销量排名，也不表示未来供货保证。

选型理由：兼顾较新端侧处理与已有超低功耗生态；供电、电平与 SDK 分别核对。
...
[官方资料入口](https://ambiq.com/product/apollo510/) · [101–200 总清单](../../ECOSYSTEM_101_200.md)
