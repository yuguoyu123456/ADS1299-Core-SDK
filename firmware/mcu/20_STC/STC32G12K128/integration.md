# Integration with STC-ISP device support

1. Install the official `STC-ISP device support` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `STC32G12K128` / `STC32G12K128 development board`.
...
callback adapter and ADS1299-independent tests. Pin `pin in Keil/SDCC project` in the
