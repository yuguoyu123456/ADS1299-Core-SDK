# STC32G12K128 ADS1299 Port

Global ecosystem rank: **42**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: STC
- Family / MCU: STC32 / STC32G12K128
- Architecture: enhanced 8051
- Reference board: STC32G12K128 development board
- Official environment: STC-ISP device support
