#include "nuvoton_ads1299_ready_app.h"

static ads1299_status_t nuvoton_apply_profile(ads1299_t *dev,
                                         ...
                                         int verify_registers)
{
    ...
    return nuvoton_apply_profile(dev, profile, verify_registers);
}
