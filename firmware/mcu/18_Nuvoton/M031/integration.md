# Integration with NuMicro device BSP

1. Install the official `NuMicro device BSP` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `M031` / `Select an official M031 evaluation board`.
