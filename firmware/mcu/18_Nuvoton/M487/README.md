# M487JIDAE ADS1299 Port

Global ecosystem rank: **40**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Nuvoton
- Family / MCU: M480 / M487JIDAE
- Architecture: Arm Cortex-M4F
- Reference board: NuMaker-M487
- Official environment: NuMicro M480 BSP
- Compiler: arm-none-eabi-gcc / Arm Compiler
