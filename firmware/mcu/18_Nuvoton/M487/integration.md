# Integration with NuMicro M480 BSP

1. Install the official `NuMicro M480 BSP` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `M487JIDAE` / `NuMaker-M487`.
