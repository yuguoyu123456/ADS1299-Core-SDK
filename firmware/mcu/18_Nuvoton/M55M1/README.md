...
Global ecosystem rank: **49**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Nuvoton
- Family / MCU: M55M1 / M55M1
- Architecture: Arm Cortex-M55
- Reference board: Select an official M55M1 evaluation board
- Official environment: NuMicro BSP
