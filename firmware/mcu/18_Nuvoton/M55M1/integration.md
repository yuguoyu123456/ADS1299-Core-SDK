# Integration with NuMicro BSP

1. Install the official `NuMicro BSP` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `M55M1` / `Select an official M55M1 evaluation board`.
