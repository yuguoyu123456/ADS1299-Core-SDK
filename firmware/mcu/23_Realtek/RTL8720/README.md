# RTL8720 ADS1299 Port

Global ecosystem rank: **29**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Realtek
- Family / MCU: RTL8720 / RTL8720
- Architecture: Arm Cortex-M class
- Reference board: Select an official RTL8720 evaluation board
- Official environment: Ameba SDK
