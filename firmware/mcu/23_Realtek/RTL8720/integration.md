# Integration with Ameba SDK

1. Install the official `Ameba SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `RTL8720` / `Select an official RTL8720 evaluation board`.
