#include "realtek_ads1299_ready_app.h"

static ads1299_status_t realtek_apply_profile(ads1299_t *dev,
                                         ...
                                         int verify_registers)
{
    ...
    return realtek_apply_profile(dev, profile, verify_registers);
}
