# Integration with Realtek SDK

1. Install the official `Realtek SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `RTL87xx` / `Select an official RTL87xx evaluation board`.
