# RTL87xx ADS1299 Port

Global ecosystem rank: **66**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Realtek
- Family / MCU: RTL87xx / RTL87xx
- Architecture: Arm Cortex-M class
- Reference board: Select an official RTL87xx evaluation board
- Official environment: Realtek SDK
