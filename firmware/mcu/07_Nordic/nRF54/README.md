...
Global ecosystem rank: **22**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Nordic Semiconductor
- Family / MCU: nRF54 / nRF54
- Architecture: Arm Cortex-M33
- Reference board: Select an official nRF54 evaluation board
- Official environment: nRF Connect SDK
