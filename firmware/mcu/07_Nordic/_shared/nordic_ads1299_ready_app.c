#include "nordic_ads1299_ready_app.h"
#include "ads1299_profiles.h"
#include "ads1299_regs.h"

ads1299_status_t nordic_ads1299_prepare(ads1299_t *dev,
                                       nordic_ads1299_profile_t profile,
...
ads1299_status_t nordic_ads1299_start(ads1299_t *dev)
{
    if (dev == 0) {
        return ADS1299_EINVAL;
    }
...
ads1299_status_t nordic_ads1299_read_one(ads1299_t *dev,
                                        nordic_ads1299_ready_state_t *state)
{
    ads1299_status_t st;
...
ads1299_status_t nordic_ads1299_stop(ads1299_t *dev)
{
    if (dev == 0) {
        return ADS1299_EINVAL;
    }
