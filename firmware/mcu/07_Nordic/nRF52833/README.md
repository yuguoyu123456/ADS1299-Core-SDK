# nRF52833 ADS1299 Port

Global ecosystem rank: **168**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Nordic Semiconductor
- Family / MCU: nRF52833 / nRF52833
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official nRF52833 evaluation board
- Official environment: nRF Connect SDK / supported device SDK
...
当前是 **Planned** 目录和通用回调模板，尚未实现 nRF52833 的官方 SDK 绑定。
编号是项目维护顺序，不是全球销量排名，也不表示未来供货保证。

选型理由：补充短距离无线和蜂窝应用处理器候选；无线发送与采集时序分别验证。
...
[官方资料入口](https://www.nordicsemi.com/Products) · [101–200 总清单](../../ECOSYSTEM_101_200.md)
