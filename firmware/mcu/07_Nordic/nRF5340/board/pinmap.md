...
|---|---|---|---|
| SCK | P1.04 | SPI clock | 3.3 V digital |
| MOSI / DIN | P1.06 | MCU to ADS1299 | 3.3 V digital |
| MISO / DOUT | P1.05 | ADS1299 to MCU | 3.3 V digital |
| CS | P1.07 | active-low chip select | 3.3 V digital |
| DRDY | P1.08 | active-low data ready | 3.3 V digital |
| RESET | P1.09 | active-low reset | 3.3 V digital |
