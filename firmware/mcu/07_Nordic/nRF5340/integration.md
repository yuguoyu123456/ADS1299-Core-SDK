# Integration with nRF Connect SDK / Zephyr

1. Install the official `nRF Connect SDK / Zephyr` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `nRF5340 application core` / `nRF5340 DK`.
...
callback adapter and ADS1299-independent tests. Pin `Zephyr 3.7.1 verified; NCS 3.4.0 CI not run` in the
