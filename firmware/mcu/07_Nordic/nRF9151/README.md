# nRF9151 ADS1299 Port

Global ecosystem rank: **169**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Nordic Semiconductor
- Family / MCU: nRF9151 / nRF9151
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official nRF9151 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 nRF9151 的官方 SDK 绑定。
