# Integration with nRF Connect SDK / supported device SDK

1. Install the official `nRF Connect SDK / supported device SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `nRF52832` / `Select an official nRF52832 evaluation board`.
