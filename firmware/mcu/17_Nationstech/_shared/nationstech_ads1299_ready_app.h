#ifndef NATIONSTECH_ADS1299_READY_APP_H
#define NATIONSTECH_ADS1299_READY_APP_H
...
typedef enum {
    NATIONSTECH_ADS1299_PROFILE_EEG_250 = 0,
    NATIONSTECH_ADS1299_PROFILE_EEG_500,
    NATIONSTECH_ADS1299_PROFILE_EEG_1000,
    NATIONSTECH_ADS1299_PROFILE_INTERNAL_TEST,
    NATIONSTECH_ADS1299_PROFILE_INPUT_SHORT
} nationstech_ads1299_profile_t;
