# N32L406 ADS1299 Port

Global ecosystem rank: **193**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Nationstech
- Family / MCU: N32L406 / N32L406
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official N32L406 evaluation board
- Official environment: N32 device firmware library
...
当前是 **Planned** 目录和通用回调模板，尚未实现 N32L406 的官方 SDK 绑定。
编号是项目维护顺序，不是全球销量排名，也不表示未来供货保证。

选型理由：补充 N32 低功耗和通用控制候选；具体板卡与供货情况待核对。
...
[官方资料入口](https://www.nationstech.com/) · [101–200 总清单](../../ECOSYSTEM_101_200.md)
