# Integration with N32G45x Firmware Library

1. Install the official `N32G45x Firmware Library` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `N32G455VEL7` / `N32G455 evaluation board`.
...
callback adapter and ADS1299-independent tests. Pin `pin in consuming project` in the
