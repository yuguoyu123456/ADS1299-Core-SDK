# Integration with N32 device firmware library

1. Install the official `N32 device firmware library` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `N32G430` / `Select an official N32G430 evaluation board`.
