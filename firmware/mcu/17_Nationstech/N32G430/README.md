# N32G430 ADS1299 Port

Global ecosystem rank: **194**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Nationstech
- Family / MCU: N32G430 / N32G430
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official N32G430 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 N32G430 的官方 SDK 绑定。
