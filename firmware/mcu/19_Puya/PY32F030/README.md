# PY32F030 ADS1299 Port

Global ecosystem rank: **197**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Puya
- Family / MCU: PY32F030 / PY32F030
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official PY32F030 evaluation board
- Official environment: PY32 device SDK
...
当前是 **Planned** 目录和通用回调模板，尚未实现 PY32F030 的官方 SDK 绑定。
编号是项目维护顺序，不是全球销量排名，也不表示未来供货保证。

选型理由：补充低成本采集控制候选；能否容纳统一 Core 需要实际编译证明。
...
[官方资料入口](https://www.puyasemi.com/) · [101–200 总清单](../../ECOSYSTEM_101_200.md)
