# Integration with PY32 device SDK

1. Install the official `PY32 device SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `PY32F072` / `Select an official PY32F072 evaluation board`.
