# Integration with PY32 HAL

1. Install the official `PY32 HAL` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `PY32F403` / `PY32F403 evaluation board`.
