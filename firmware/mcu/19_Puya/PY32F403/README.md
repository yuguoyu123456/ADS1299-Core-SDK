# PY32F403 ADS1299 Port

Global ecosystem rank: **41**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Puya
- Family / MCU: PY32 / PY32F403
- Architecture: Arm Cortex-M class
- Reference board: PY32F403 evaluation board
- Official environment: PY32 HAL
