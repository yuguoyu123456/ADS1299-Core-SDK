...
Global ecosystem rank: **123**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Espressif
- Family / MCU: ESP32-C5 / ESP32-C5
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official ESP32-C5 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 ESP32-C5 的官方 SDK 绑定。
