#ifndef ESP32C6_ADS1299_FRAME_QUEUE_H
#define ESP32C6_ADS1299_FRAME_QUEUE_H
...
#ifndef ESP32C6_ADS1299_FRAME_QUEUE_CAPACITY
#define ESP32C6_ADS1299_FRAME_QUEUE_CAPACITY 16u
#endif
...
typedef struct {
    ...
    uint32_t sequence;
} esp32c6_ads1299_frame_record_t;

typedef struct {
    esp32c6_ads1299_frame_record_t items[ESP32C6_ADS1299_FRAME_QUEUE_CAPACITY];
    size_t head;
    size_t tail;
    size_t count;
    size_t high_watermark;
    uint32_t dropped;
} esp32c6_ads1299_frame_queue_t;
