...
- Device/family candidate: ESP32-C3; vendor: Espressif.
- [Official discovery entry](https://www.espressif.com/en/products/socs). This may be a vendor catalog, not an exact-part datasheet.
