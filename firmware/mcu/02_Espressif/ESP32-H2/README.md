# ESP32-H2 ADS1299 Port

Global ecosystem rank: **124**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Espressif
- Family / MCU: ESP32-H2 / ESP32-H2
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official ESP32-H2 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 ESP32-H2 的官方 SDK 绑定。
