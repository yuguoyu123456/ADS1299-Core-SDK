...
#include <string.h>
static int fail(ads1299_esp32_context_t *ctx) { ctx->fault=1; return -1; }
static int transfer(void *user,const uint8_t *tx,uint8_t *rx,size_t len)
{
    ads1299_esp32_context_t *ctx=user;
...
int ads1299_esp32_make_hal(ads1299_esp32_context_t *ctx,ads1299_platform_hal_t *hal)
{
