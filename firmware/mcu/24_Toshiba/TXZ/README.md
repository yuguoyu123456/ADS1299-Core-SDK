...
Global ecosystem rank: **59**. Status: **Reference**. Tier B. Hardware validation is not implied.
...
- Reference board: Select an official TXZ evaluation board
- Official environment: TXZ+ Peripheral Drivers
