# Integration with TXZ+ Peripheral Drivers

1. Install the official `TXZ+ Peripheral Drivers` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `TXZ` / `Select an official TXZ evaluation board`.
