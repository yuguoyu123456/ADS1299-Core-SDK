# STM32L152 ADS1299 Port

Global ecosystem rank: **117**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: STMicroelectronics
- Family / MCU: STM32L152 / STM32L152
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official STM32L152 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 STM32L152 的官方 SDK 绑定。
