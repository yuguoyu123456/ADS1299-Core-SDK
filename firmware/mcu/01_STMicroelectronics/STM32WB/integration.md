# Integration with STM32CubeWB

1. Install the official `STM32CubeWB` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `STM32WB` / `Select an official STM32WB evaluation board`.
