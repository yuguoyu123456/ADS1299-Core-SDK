# STM32WB ADS1299 Port

Global ecosystem rank: **27**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: STMicroelectronics
- Family / MCU: STM32WB / STM32WB
- Architecture: dual Arm Cortex-M4/M0+
- Reference board: Select an official STM32WB evaluation board
- Official environment: STM32CubeWB
