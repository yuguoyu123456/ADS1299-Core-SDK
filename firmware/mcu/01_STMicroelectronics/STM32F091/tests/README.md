...
These tests exercise the repository-owned STM32F091 ADS1299 port together with the shared ADS1299 core on a normal desktop C compiler. They are intended to catch API drift and adapter regressions before a CubeIDE board build.
...
firmware/mcu/01_STMicroelectronics/STM32F091/ads1299_port/*.c
```
...
For real-board bring-up, use the STM32F091 model Quick Start and keep SPI configured as ADS1299 Mode 1 (CPOL=0, CPHA=1), 8-bit, MSB-first.
