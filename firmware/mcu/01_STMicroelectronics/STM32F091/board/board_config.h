#ifndef ADS1299_STM32F091_BOARD_CONFIG_H
#define ADS1299_STM32F091_BOARD_CONFIG_H

/* Single board-specific configuration point for the STM32F091 beginner path.
 * Reference board: NUCLEO-F091RC (MB1136, STM32F091RCT6).
 * Configure SPI1 as master/full-duplex/8-bit/MSB-first, CPOL Low, CPHA 2Edge
 * (ADS1299 SPI Mode 1). ADS1299 register/profile behavior belongs in shared
 * core and must not be changed when board pins or peripheral instances change.
 *
 * Reference Arduino-header mapping on NUCLEO-F091RC:
 * SCLK PA5/D13, MISO PA6/D12, MOSI PA7/D11, CS PB6/D10,
 * START PB10/D6, PWDN PB4/D5, RESET PB5/D4, DRDY PA10/D2.
 * USART2_TX PA2/D1 is the default optional host-stream TX choice.
 *
 ...
 * matching *_Pin and *_GPIO_Port macros referenced below.
 */
