...
Global ecosystem rank: **58**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: STMicroelectronics
- Family / MCU: STM8 / STM8
- Architecture: 8-bit STM8
- Reference board: Select an official STM8 evaluation board
- Official environment: STM8 Standard Peripheral Library
