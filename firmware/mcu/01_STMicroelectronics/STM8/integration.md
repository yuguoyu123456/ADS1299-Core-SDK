# Integration with STM8 Standard Peripheral Library

1. Install the official `STM8 Standard Peripheral Library` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `STM8` / `Select an official STM8 evaluation board`.
