# Integration with STM32CubeWL

1. Install the official `STM32CubeWL` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `STM32WL` / `Select an official STM32WL evaluation board`.
