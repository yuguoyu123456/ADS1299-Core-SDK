# STM32WL ADS1299 Port

Global ecosystem rank: **28**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: STMicroelectronics
- Family / MCU: STM32WL / STM32WL
- Architecture: Arm Cortex-M4
- Reference board: Select an official STM32WL evaluation board
- Official environment: STM32CubeWL
