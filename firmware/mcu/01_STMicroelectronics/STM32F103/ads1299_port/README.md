...
This directory is the STM32F103 platform-adapter layer for the shared ADS1299 core in `firmware/core_driver/ads1299`.
...
```text
PASS STM32F103 ads1299_port host self-test
```
...
- Physical STM32F103 + ADS1299 operation: NOT BOARD-VERIFIED
