...
These tests exercise the repository-owned STM32F103 ADS1299 port together with the shared ADS1299 core on a normal desktop C compiler. They are intended to catch API drift and adapter regressions before a CubeIDE board build.
