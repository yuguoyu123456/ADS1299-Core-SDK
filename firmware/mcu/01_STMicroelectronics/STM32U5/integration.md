# Integration with STM32CubeU5

1. Install the official `STM32CubeU5` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `STM32U575ZI` / `NUCLEO-U575ZI-Q; provisional control GPIOs`.
...
callback adapter and ADS1299-independent tests. Pin `CubeU5 1.1.0 linker; CMSIS device 624374fa; GNU reference verified` in the
