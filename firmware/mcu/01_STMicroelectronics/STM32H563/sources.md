...
- Device/family candidate: STM32H563; vendor: STMicroelectronics.
- [Official discovery entry](https://www.st.com/en/microcontrollers-microprocessors/STM32-32-bit-arm-cortex-mcus.html). This may be a vendor catalog, not an exact-part datasheet.
