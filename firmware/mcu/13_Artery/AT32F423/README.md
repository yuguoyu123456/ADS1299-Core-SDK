# AT32F423 ADS1299 Port

Global ecosystem rank: **186**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Artery
- Family / MCU: AT32F423 / AT32F423
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official AT32F423 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 AT32F423 的官方 SDK 绑定。
