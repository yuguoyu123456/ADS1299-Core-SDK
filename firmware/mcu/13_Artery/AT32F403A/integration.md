# Integration with AT32 device firmware library

1. Install the official `AT32 device firmware library` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `AT32F403A` / `Select an official AT32F403A evaluation board`.
