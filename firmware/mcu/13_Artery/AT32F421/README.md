# AT32F421 ADS1299 Port

Global ecosystem rank: **185**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Artery
- Family / MCU: AT32F421 / AT32F421
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official AT32F421 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 AT32F421 的官方 SDK 绑定。
