# Integration with AT32F435/437 Firmware Library

1. Install the official `AT32F435/437 Firmware Library` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `AT32F435ZMT7` / `AT-START-F435`.
