# APM32F072 ADS1299 Port

Global ecosystem rank: **187**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Geehy
- Family / MCU: APM32F072 / APM32F072
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official APM32F072 evaluation board
...
当前是 **Planned** 目录和通用回调模板，尚未实现 APM32F072 的官方 SDK 绑定。
