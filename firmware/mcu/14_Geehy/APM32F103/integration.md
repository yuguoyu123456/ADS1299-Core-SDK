# Integration with APM32 device SDK

1. Install the official `APM32 device SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `APM32F103` / `Select an official APM32F103 evaluation board`.
