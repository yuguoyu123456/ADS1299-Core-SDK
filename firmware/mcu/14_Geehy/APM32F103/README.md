# APM32F103 ADS1299 Port

Global ecosystem rank: **188**. Status: **Planned**. Tier C. Hardware validation is not implied.

## Platform

- Vendor: Geehy
- Family / MCU: APM32F103 / APM32F103
- Architecture: Confirm exact CPU/core variant in official device documentation
- Reference board: Select an official APM32F103 evaluation board
- Official environment: APM32 device SDK
...
当前是 **Planned** 目录和通用回调模板，尚未实现 APM32F103 的官方 SDK 绑定。
编号是项目维护顺序，不是全球销量排名，也不表示未来供货保证。

选型理由：补充已有工程迁移候选；不能据命名推定与其他厂商二进制兼容。
...
[官方资料入口](https://www.geehy.com/) · [101–200 总清单](../../ECOSYSTEM_101_200.md)
