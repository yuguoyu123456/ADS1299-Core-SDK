...
Global ecosystem rank: **47**. Status: **Reference**. Tier B. Hardware validation is not implied.

## Platform

- Vendor: Geehy
- Family / MCU: APM32M / APM32M
- Architecture: Arm Cortex-M class
- Reference board: Select an official APM32M evaluation board
- Official environment: APM32 SDK
