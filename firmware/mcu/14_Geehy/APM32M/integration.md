# Integration with APM32 SDK

1. Install the official `APM32 SDK` environment; do not copy the vendor SDK into this repository.
2. Create or open a vendor project for `APM32M` / `Select an official APM32M evaluation board`.
